...
export ZSH="/Users/jacobdubinsky/.oh-my-zsh"
...
alias rapi='. api-venv/bin/activate && ddtrace-run gunicorn app:app -b 0.0.0.0:5000 -w 1 --reload -k gevent --log-level info --capture-output --error-logfile -'
